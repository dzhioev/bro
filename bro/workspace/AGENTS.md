...
- `paths.py` — explicit repository-root resolution, the flat global runtime paths, fixed in-container mount paths, workspace naming, venv environment helpers, and `RuntimeLocationError`
