...
`spell::run-feature` is your flagship procedure: it walks a feature from goal to
verified-and-closed through a chain of summoned sub-sessions. `spell::ask` covers the
