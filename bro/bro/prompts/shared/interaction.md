...
After each task manipulation via flow MCP tools (or batch of related manipulations), show a short summary with a markdown hyperlink to the task and what was done — e.g. "[task name](notion-url): appended landing log and marked Done".
