...
- **the bro's system prompt** — the class-level `system_prompt` of the bro or of the ancestor that owns the rule; shared text under `bro/bro/prompts/shared/*.md` only when the lesson genuinely applies to every bro
