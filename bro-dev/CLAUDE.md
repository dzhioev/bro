...
- `bro_dev/install.py` — installs the framework's commit-footer hooks (`bro/workflow/commit_footer.py`) and the repo-local `git golc` alias into the current repository
