...
`bro-dev` contains repository-development tooling kept out of the `bro` runtime distribution: console-script metadata generation, commit token footers and reports, shell-policy checks, repository hook installation, and the `bro-dev` development persona.
