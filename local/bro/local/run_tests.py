...
PYTEST_FILES = [
  ...
  'ride/ride/ride/claude/claude_argv_test.py',
  'ride/ride/ride/claude/claude_config_test.py',
  'ride/ride/cw_test.py',
  'ride/ride/cli_test.py',
  'ride/ride/flags_test.py',
  'ride/ride/scope_report_test.py',
  'ride/ride/ride/claude/mcp_test.py',
  'ride/ride/ride/claude/runner_test.py',
  'ride/ride/ride/claude/claude_auth_test.py',
  'ride/ride/ride/claude/session_context_test.py',
  'ride/ride/ride/claude/recorder_test.py',
  'ride/ride/session_test.py',
  'ride/ride/ride/claude/system_prompt_test.py',
  ...
  'ride/ride/ride/claude/statusline_test.py',
