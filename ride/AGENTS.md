...
- `ride/dive_in.py` — task utility wrapper: prefetch, task-derived workspace naming, `CW_TASK_ID`, fresh-origin base selection, hold defaults, and forwarding to `ride along` with the project-default bro.
