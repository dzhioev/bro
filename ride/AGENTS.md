...
- `ride/runtime_state.py` — one-shot migration of historical checkout-keyed stores into the flat global root, including collision/liveness preflight and workspace attachment backfill.
