...
- `bros/dev/` — generic developer with the file/search toolset, an unrestricted core shell roster, and the audit, credential-wiring, framework-bump, task, PR, and landing spells.
